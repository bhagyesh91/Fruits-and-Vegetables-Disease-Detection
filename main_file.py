...
root.title("fruit and vegetable disease detection ")
...
w = tk.Label(root, text=" Fruit And Vegetable Disease Detection system ",width=40,background="#212F3D",foreground="white",height=2,font=("Times new roman",19,"bold"))
w.place(x=0,y=15)
...
wlcm=tk.Label(root,text="......Welcome to   Fruit And Vegetable Disease Detection system  ......",width=95,height=3,background="#212F3D",foreground="white",font=("Times new roman",22,"bold"))
